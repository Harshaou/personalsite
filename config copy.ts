const siteMetadata = {
    ...
    about:
        `I'm Harshad. I'm a React, Javascript enthusiast. I was working as a front end developer for the last 10 months in Webdura technologies.
          ...
          which I'm so excited about. Tools like Gatsby and Next is enabling this new kind of web experience from the development experience to great performance,
